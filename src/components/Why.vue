<template>
    <div class="w-4/5 lg:w-full flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-36">
  ...
  data() {
    return {
        whys: [
            ...
            {
              id: 2,
              src: "src/assets/img/task.svg",
              alt: "Icon - Task",
              title: "We are task oriented.",
              text: "Give a detailed description of the service being provided here.",
            },
            {
              id: 3,
              src: "src/assets/img/screen.svg",
              alt: "Icon - Screen",
